      ...
      <div className="container mb-5">
        <div className="row">
          <div className="col-xs-12 col-sm-12 col-lg-4   info-servicios">
            <img src="https://img.icons8.com/carbon-copy/100/undefined/nail-polish.png" />
            <div>
              <h3> Manicura </h3>
              <p>
          ...
          <div className="col-xs-12col-sm-12 col-lg-4   info-servicios">
            <img src="https://img.icons8.com/ios/100/undefined/scissors.png" />
            <div>
              <h3> Peluqueria</h3>
              <p>
                Incluso el Señalador todopoderoso
          ...
          <div className=" col-xs-12 col-sm-12 col-lg-4  info-servicios">
            <img src="https://img.icons8.com/ios/100/undefined/eyebrow.png" />
            <div>
              <h3>pestañas</h3>
              <p>
                Incluso el Señalador todopoderoso
